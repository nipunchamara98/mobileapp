...
public class EditProfile extends AppCompatActivity {
   ...
   // private SharedPreferencesManager manager;
        ...
        backImg.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(utype.equals("user")){
                    ...
                    startActivity(new Intent(EditProfile.this, com.moutamid.quickdrop.driver.MainScreen.class));
                    finish();
                }
            }
        });
    ...
    private void storeDriver(){
        ...
        Intent intent = new Intent(EditProfile.this, com.moutamid.quickdrop.driver.MainScreen.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
        finish();
